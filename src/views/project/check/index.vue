            ...
            <el-col :sm="12" :lg="5">
              <el-form-item label="项目名称">
                <el-input
                  placeholder="请输入"
                  size="medium"
                  v-model.trim="searchForm.value3"
                  :maxlength="20"
                ></el-input>
              </el-form-item>
            </el-col>
        ...
        <el-row class="mt20">
          <div class="table-list">
            <el-table :data="tableData" border>
              ...
              <el-table-column prop="address" label="招商区块" align="center">
              </el-table-column>
              <el-table-column prop="address" label="投资单位" align="center">
              </el-table-column>
              <el-table-column
                prop="address"
                label="在龙注册企业名称"
              ...
              <el-table-column prop="address" label="投资金额" align="center">
              </el-table-column>
              <el-table-column
                prop="address"
                label="投资方式"
...
import HandleComponent from "../components/Details.vue";
import { getPageList, getDetail } from "@/api/project/audit";
export default {
  mixins: [baseList],
  components: {
    HandleComponent
